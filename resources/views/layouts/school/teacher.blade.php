...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[var(--pc-bg)] font-sans text-slate-900 antialiased">
        @php
            ...
            $user = auth()->user();
            $navigation = [
                ['label' => 'Dashboard', 'route' => 'school.teacher.dashboard'],
                ['label' => 'Exam Mode', 'route' => 'school.teacher.dashboard', 'params' => ['exam-mode' => 1], 'active' => request()->routeIs('school.teacher.dashboard') && request()->query('exam-mode') == '1'],
                ['label' => 'Students', 'route' => 'school.teacher.students.index'],
                ['label' => 'Assignments', 'route' => 'school.teacher.assignments.index'],
                ['label' => 'Results', 'route' => 'school.teacher.results.index'],
                ['label' => 'Payments', 'route' => 'school.teacher.payments.index'],
            ];
        @endphp
        ...
        <div class="min-h-screen lg:grid lg:grid-cols-[18rem_minmax(0,1fr)]">
            <aside class="hidden border-r border-slate-200/80 bg-white/92 text-slate-700 backdrop-blur lg:flex lg:flex-col">
                <div class="border-b border-slate-200 px-6 py-6">
                    <a href="{{ route('school.teacher.dashboard', ['slug' => $school->slug]) }}" wire:navigate class="inline-flex items-center text-lg font-semibold tracking-tight text-slate-950">
                        ParentConnecta
                    </a>
            ...
            <div class="min-w-0">
                <header class="border-b border-slate-200/80 bg-white/95 backdrop-blur lg:hidden">
                    <div class="flex items-center justify-between px-4 py-4 sm:px-6">
                        ...
                        <a
                            href="{{ route('school.teacher.dashboard', ['slug' => $school->slug]) }}"
                            wire:navigate
